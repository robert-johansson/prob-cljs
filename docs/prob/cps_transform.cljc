(ns prob.cps-transform
  "Pure CPS form transformer. Runs at macro expansion time.

   This is a .cljc file shared between:
   - prob.cps (ClojureScript, for SCI/Scittle macros)
   - prob.macros (Clojure, for nbb macros)

   Takes Clojure/Script forms and returns CPS-transformed code.
